                ...
                <div class="col-12">
                    <div class="card ">
                        <div class="card-header text-right ">
                            <h3 class="card-title  ">Eddit Jobs Details</h3>
                            <button type="button" class="btn btn-sm btn-primary"
                                onclick="window.location='{{ url('task') }}'">
                        ...
                        <div class="card-body">
                            ...
                            <form method="POST" enctype="multipart/form-data" action="{{ url('task/updatejobdetail') }}">
                                @csrf
                                <div class="card-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea readonly class="form-control @error('deskripsi')is-invalid   @enderror" rows="3" placeholder="Enter ..." name="deskripsi" readonly >{{$deskripsi}}</textarea>
