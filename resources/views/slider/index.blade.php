                    ...
                    <div class="card ">
                        <div class="card-header text-right ">
                            ...
                            <button type="button" class="btn btn-sm btn-primary"
                                onclick="window.location='{{ url('slider/add') }}'">
                                    ...
                                    @foreach ($slider as $row)
                                        <tr>
                                            ...
                                            <td><button class="btn btn-sm btn-info" title="Edit Data"
                                                    onclick="window.location='{{ url('slider/' . $row->id) }}'">
                                                    <i class="fas fa-edit"></i>
                                                </button>
                                                        
                                                        <a href="#" class="btn btn-warning btn-sm deleteslider" data-id="{{ $row->id }}" data-nama="{{ $row->judul }}"   > <i class="fas fa-trash-alt"></i></a>                             
