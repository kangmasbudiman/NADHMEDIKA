            ...
            <div class="row">
                <div class="col-12">
                    <div class="card ">
                        ...
                        <!-- /.card-header -->
                        <div class="card-body">
                            <form method="POST" enctype="multipart/form-data" action="{{ url('blog/'.$id) }}">
                                @csrf
                                @method('PUT')
                                <div class="card-body">
                                   <!-- 
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="idkategori" class="form-control @error('idkategori')is-invalid   @enderror">
                                        <option value="{{$idkategori}}"> {{$idkategori}}  </option>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="statustrending" class="form-control @error('statustrending')is-invalid   @enderror">
                                            <option value="{{$statustrending}}">{{$statustrending}}</option>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" readonly value="{{ $penulis }}"
