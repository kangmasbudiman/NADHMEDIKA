                    ...
                    <div class="card card-primary card-outline">
                        <div class="card-body box-profile">
                            <div class="text-center">
                                <img class="profile-user-img img-fluid img-circle" src="{{ asset('storage/' . $user->foto) }}"
                            ...
                            <ul class="list-group list-group-unbordered mb-3">
                                <li class="list-group-item">
                                    <b>Ratting</b> <a class="float-right">{{ $user->userRating }}<i
                                            class="fa fa-star"></i></a>
                                </li>

                            </ul>

                            <a href="" type="button" class="btn btn-primary btn-block" data-toggle="modal"
                                data-target="#exampleModal"><b>Update Password</b></a>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-10">
                                                <input type="text" class="form-control" id="inputName2"
                                                    placeholder="Name" value="{{ $user->username }}" name="username">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <label for="inputExperience" class="col-sm-2 col-form-label">Tempat
                                                Lahir</label>
                                            <div class="col-sm-10">
                                                <input type="text" class="form-control" id="inputName2"
                                                    placeholder="Name" value="{{ $user->tempatlahir }}" name="tempatlahir">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-10">
                                                <input type="date" class="form-control" id="inputSkills"
                                                    placeholder="Skills" value="{{ $user->tanggal }}" name="tanggal">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            ...
                                            @foreach ($jobs as $row)
                                                <tr>
                                                    ...
                                                    <td><button class="btn btn-sm btn-info" title="Edit Data"
                                                        ...
                                                        <form onsubmit="return deleteData( '{{ $row->jobTitle }}')"
